...
public interface IReadApi
{
    ...
    public Task<SuiObjectReadResult<SuiParsedData<T>>[]> GetObjects<T>(params ObjectId[] objectId);
    ...
    public Task<SuiTransactionResponse[]> GetTransactions(params TransactionDigest[] digest);
